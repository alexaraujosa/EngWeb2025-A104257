    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    ...
                    <td>
                        <a href="/alunos/edit/${slist[i].id}">
                            <button class="w3-btn w3-green w3-mb-2" type="submit">Edit</button>
                        </a>
                        <a href="/alunos/delete/${slist[i].id}">
                            <button class="w3-btn w3-red w3-mb-2" type="submit" onclick="return confirm('Tem a certeza que quer apagar o registo?');">Delete</button>
                        </a>
                    </td>
                </tr>
        `
...
exports.studentRegisterConfirm = function(aluno, d) {
    let html = `
    <!DOCTYPE html>
    <html>
        <head>
            <title>${aluno.id} | REGISTO</title>
            <meta charset="utf-8"/>
            <link rel="icon" href="favicon.png"/>
            <link rel="stylesheet" href="w3.css"/>
        </head>
        <body>
            <div class="w3-panel w3-green">
                ...
                <ul>
                    ...
                    <li><b>Git (Link): </b>${aluno.gitlink}</li>
                </ul>
            </div>
    ...
    html += `
            ...
            <footer class="w3-container w3-teal">
                <address>Generated by EngWeb2025 in ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </body>
    </html>
    `
...
exports.studentEditConfirmPage = function(aluno, d) {
    let html = `
    <!DOCTYPE html>
    <html>
        <head>
            <title>${aluno.id} | EDIÇÃO</title>
            <meta charset="utf-8"/>
            <link rel="icon" href="favicon.png"/>
            <link rel="stylesheet" href="w3.css"/>
        </head>
        <body>
            <div class="w3-panel w3-green">
                <h4>Aluno editado com sucesso!</h4>
                <h6>Novas informações do Aluno:</h6>
                <ul>
                    <li><b>ID: </b>${aluno.id}</li>
                    <li><b>Nome: </b>${aluno.nome}</li>
                    <li><b>Git (Link): </b>${aluno.gitlink}</li>
...
exports.studentDeletePage = function(id, d) {
    let html = `
    <!DOCTYPE html>
    <html>
        <head>
            <title>${id} | REMOVIDO</title>
            <meta charset="utf-8"/>
            <link rel="icon" href="favicon.png"/>
            <link rel="stylesheet" href="w3.css"/>
        </head>
